...
///==================== Colors ====================
class ColorsManager {
  // static const primary = Color(0xFFFF7E65); // before 0xFFFF7E65
  // static const primary75 =
  //     Color(0xFFFF9E8B); //primaryColor with 75% Opacity // before 0xFFFF9E8B
  // static const primary50 =
  //     Color(0xFFFFBFB3); //primaryColor with 50% Opacity // before 0xFFFFBFB3
  // static const primary25 =
  //     Color(0xFFFFDFD8); //primaryColor with 25% Opacity // before 0xFFFFDFD8
  // static const primaryBlue = Color(0xFF364454); // before 0xFF364454
