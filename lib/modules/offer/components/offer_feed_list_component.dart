        ...
        return Obx(
          () => OfferCard(
            ...
            bottomActionWidgetList: feedController
                ...
                : feedController.feedListRepsonse[index].dateOfferEnd!
                        .isBefore(now)
                    ? []
                    : <Widget>[
                        Expanded(
                                ...
                                ConfirmationDialogWidget(
                                  ...
                                  onPressed: () async {
                                    feedController
                                      ...
                                      actionType: OfferStrings.hideAction,
                                      jobOfferId: feedController
                                          .feedListRepsonse[index].id,
                                    );
                                    feedController.feedListRepsonse[index]
                                            .rejectedState =
                                        feedController
                                            .jobOfferOnClickBoolSwitching(
                                      boolValue: feedController
                                          .feedListRepsonse[index]
                                          .rejectedState,
                                    );
                                    Get.back();
                                  },
